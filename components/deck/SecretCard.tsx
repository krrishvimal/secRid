...
export function SecretCard({
  ...
  return (
    <div className="w-full h-full max-h-[72vh] flex flex-col justify-between p-6 sm:p-8 rounded-[28px] bg-gradient-to-b from-[#151924] to-[#0D1017] border border-[#232A3B] shadow-2xl relative overflow-hidden select-none">
      ...
      {/* Card Header: Intent Pill & Report */}
      ...
      {/* Hero Secret Text (Centered & Weighted) */}
      <div className="my-auto py-6 z-10 flex flex-col justify-center">
        <p className="text-lg sm:text-xl text-slate-100 font-serif leading-relaxed sm:leading-loose text-center font-normal tracking-wide">
      ...
      <div className="pt-4 border-t border-white/[0.06] flex items-center justify-between gap-3 z-10">
        ...
        <button
          ...
          className={`flex-1 py-3 px-4 rounded-2xl flex items-center justify-center gap-2 text-xs font-semibold transition-all ${
            secret.hasUserFelt
        ...
        {intentConfig.allowLetters ? (
          <button
            ...
            className="flex-1 py-3 px-4 rounded-2xl bg-sanctuary-accent/20 hover:bg-sanctuary-accent/30 text-sanctuary-accent border border-sanctuary-accent/40 flex items-center justify-center gap-2 text-xs font-semibold transition-all shadow-lg shadow-sanctuary-accent/10"
          >
